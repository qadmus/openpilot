...
maneuvers = [
  # intention: switch between lead, cruise gas, and cruise coast
Maneuver(
    "following a car at 55mph flat, lead accel and decel every 10s",
    duration=100.,
    initial_speed=25.,
    lead_relevancy=True,
    initial_distance_lead=60.,
    speed_lead_values=[25., 25., 20., 30., 20., 30.],
    speed_lead_breakpoints=[0., 10., 20., 30., 40., 50.],
    grade_values=[.0],
    grade_breakpoints=[0.],
    cruise_button_presses=[(CB.DECEL_SET, 1.), (0, 1.1)],
    checks=[check_engaged, check_no_collision],
  ),
Maneuver(
    "following a car at 55mph uphill, lead accel and decel every 10s",
    duration=100.,
    initial_speed=25.,
    lead_relevancy=True,
    initial_distance_lead=60.,
...
Maneuver(
    "following a car at 55mph downhill, lead accel and decel every 10s",
    duration=60.,
    initial_speed=25.,
    lead_relevancy=True,
    initial_distance_lead=60.,
    ...
    grade_values=[-.03],
    grade_breakpoints=[0.],
    cruise_button_presses=[(CB.DECEL_SET, 1.0), (0, 1.1)],
    checks=[check_engaged, check_no_collision],
  ),
  Maneuver(
    'while cruising at 55mph, grade: 0%, 4%, 0%, -4%, 0%',
    duration=60.,
    initial_speed=55. * CV.MPH_TO_MS,
    cruise_button_presses=[(CB.DECEL_SET, 1.2), (0, 1.3)],
    grade_values=[0., 0., .04, .04, 0., 0., -.04, -.04, 0.],
    grade_breakpoints=[0., 9., 10., 19., 20., 29., 30., 39., 40.],
